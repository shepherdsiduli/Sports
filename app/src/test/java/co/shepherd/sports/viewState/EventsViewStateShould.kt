...
class EventsViewStateShould {
    @Test
    fun `return loading true when status is loading`() {
        // Given
        val givenViewState = EventsViewState(status = Status.LOADING)
    ...
    fun `not return loading false when status is error`() {
        // Given
        val givenViewState = EventsViewState(status = Status.SUCCESS)
    ...
    fun `not return loading false when status is success`() {
        // Given
        val givenViewState = EventsViewState(status = Status.ERROR)
